...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AttemptSubmit geturl = new AttemptSubmit();
                String URL = geturl.doInBackground().toString();
    ...
    private class AttemptSubmit extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("username" + "," + "password", username + "," + password));

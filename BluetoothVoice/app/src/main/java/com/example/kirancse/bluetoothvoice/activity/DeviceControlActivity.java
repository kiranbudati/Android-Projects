package com.example.kirancse.bluetoothvoice.activity;
...
import com.example.kirancse.bluetoothvoice.DeviceData;
import com.example.kirancse.bluetoothvoice.R;
import com.example.kirancse.bluetoothvoice.Utils;
import com.example.kirancse.bluetoothvoice.bluetooth.DeviceConnector;
import com.example.kirancse.bluetoothvoice.bluetooth.DeviceListActivity;
...
public final class DeviceControlActivity extends BaseActivity {
    ...
    private final int SPEECH_RECOGNITION_CODE = 3;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_settings:
                final Intent intent = new Intent(this, com.example.kirancse.bluetoothvoice.activity.SettingsActivity.class);
